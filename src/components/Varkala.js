    ...
    <div className='m-0 p-0'>
      ...
      >
        ...
        <div className=' w-[100vw] sm:w-[50vw] md:min-h-screen flex flex-col justify-center items-start mx-auto sm:pr-32 px-10'>
          <h1 className='text-3xl font-playfair font-semibold py-4 text-[#116b89]'>
            Why Travel to Soul in Varkala?
          </h1>
          <p className='text-[#4c4e4e]'>
            Soul in Varkala is a retreat that stands on the untouched sands of
            the black beach, offering a tranquil counterpart to the vibrant surf
            life.<br></br> It’s a place where silence speaks, the sea hums, and
      ...
      <section className='flex flex-col justify-center gap-4 items-center px-5 sm:px-28 w-full relative mb-12'>
        ...
        <h2 className='text-3xl font-playfair font-semibold py-2 text-[#116b89]'>
        ...
        <div className='flex flex-col sm:flex-row justify-between gap-10 items-center w-full'>
          <div className='w-full lg:w-1/3 text-center flex justify-center gap-2 items-center border border-[#b7d2db] p-2 rounded'>
            ...
            <p className='mt-2 font-medium'>Festival News</p>
          </div>
          <div className='w-full sm:w-1/2 lg:w-1/3 text-center flex justify-center gap-2 items-center border border-[#b7d2db] p-2 rounded'>
            ...
            <p className='mt-2 font-medium'>Peaceful Stays</p>
          </div>
          <div className='w-full sm:w-1/2 lg:w-1/3 text-center flex justify-center gap-2 items-center border border-[#b7d2db] p-2 rounded'>
            <svg
              stroke='#116b89'
            ...
            <p className='mt-2 font-medium'>Inspiring Reviews</p>
          </div>
        </div>
