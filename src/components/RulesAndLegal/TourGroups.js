  ...
  return (
    <div className="w-[100vw] min-h-screen flex flex-col justify-center items-center my-16">
      ...
      <p className="w-1/2 text-[#4c4e4e]">
        We love welcoming larger groups who bring the right vibe to add to the
        energy and experience that our properties have to offer. However, we’re
        ...
        a similar approach to travel like us! We offer contracted rates and easy
